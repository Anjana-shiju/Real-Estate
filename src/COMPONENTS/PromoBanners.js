  ...
  return (
    <div className="container px-4" style={{ marginBottom: '400px', marginTop: '80px' }}> 
      <div className="row g-4">
        ...
        {/* Left Banner - Button maattathe pazhayapole nirthi */}
        <div className="col-md-6">
          ...
          >
            ...
            <h4 className="fw-bold mb-1">Extra </h4>
            <h4 className="fw-bold mb-1">10% off</h4>
            
            {/* Left Button - 'rounded-3' (maattilla) */}
            <button 
              className="btn rounded-3 fw-bold mt-2" 
              style={{ 
        ...
        {/* Right Banner - Button mathram round aakki */}
        <div className="col-12 col-md-6">
          ...
          >
            ...
            <div style={{ width: '55%' }}>
              ...
              {/* Right Side Button - 'rounded-pill' aakki */}
              <button
                className="btn rounded-pill fw-bold text-white px-2 px-md-2 py-2"
